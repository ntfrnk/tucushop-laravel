	...
	<div class="col-md-12 mainbar">
		<div class="card marB20">
			<div class="card-body pad30">
				...
				<div class="f20 lh30">
                    <div class="f16 fw500">
                        <span class="b">Remitente:</span> 
                        {{ $message->user->profile->name }} {{ $message->user->profile->lastname }}
                    </div>
                ...
                @if($message->answers && $message->answers->count() != 0)
                    ...
                    <div class="f16 fw500 marB15">
                        <span class="b">Respuestas:</span>
                    </div>

                    @foreach($message->answers as $answer)

                        <div class="f15 marT5 marB15">
                            <span class="b">
                ...
                <div class="marT25 message-resp-form">
                    ...
                    <form action="{{ route('message.answer') }}" method="post">
                        ...
                        <input type="hidden" name="sended_by" value="store">
