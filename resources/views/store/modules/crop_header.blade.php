	...
	<div class="col-md-12 mainbar">
		<div class="card marB20">
			<div class="card-body padT30 padB30 padLR30">
				...
				<div class="f17">
					<h1 class="f30 marB15">Recortar foto de portada</h1>
					<hr>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12 marT20">
						...
						<a href="javascript:;" class="show-result-header btn btn-primary spn" spn-text="Recortando la imagen...">Recortar foto</a>
