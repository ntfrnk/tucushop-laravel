					...
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td class="a-right">
									<a href="{{ route('store.message.read', ['alias' => $store->alias,'message_id' => $message->id]) }}" class="btn btn-sm btn-outline-secondary"><i class="fa fa-eye"></i><span class="d-none d-md-inline-block marL5"> Ver mensaje</span></a>
								</td>
							</tr>
							@endforeach
						</tbody>
