...
<p>Te informamos que tu consulta por el artículo <em><b>{{ $info->message->item->name }}</b></em> tiene un nuevo mensaje por parte del vendedor. Para acceder a dicha respuesta por favor dirígete a tu área de usuario, en la sección «Centro de mensajes».</p>
